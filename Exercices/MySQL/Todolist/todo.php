...
<body>
    ...
    <div class="container">
        <div class="card w-100">
            <div class="card-header  text-white">Todo</div>
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label  class="form-label" for="title">Title</label>
                        <input  class="form-control" type="text" id="title" name="title" value="<?= isset($_POST['title']) ? htmlspecialchars($_POST['title']) : '' ?>">
                        <?php
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" rows="10" name="description"><?= isset($_POST['description']) ? htmlspecialchars($_POST['description']) : '' ?></textarea>
                        <?php
